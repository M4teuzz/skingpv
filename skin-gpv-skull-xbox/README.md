...
Os analógicos e o emblema Xbox/Oni usam as artes originais, exibidas em escala de cinza pelo CSS. O novo `assets/wordmark-skull-brush.png` é integrado ao corpo com `mix-blend-mode: screen`. Os arquivos antigos foram preservados, mas o lettering CYPHERS não é usado pela skin atual.
